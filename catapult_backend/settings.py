...
SECRET_KEY = os.environ.get("SECRET_KEY", 'django-insecure-e*%$y7n7#+%-te73v&pf#iwh66q$wqvgc_&a^_x-x!-7gz0c=d')
...
DBBACKUP_CONNECTORS = {
    'default': {
        ...
        'restore_cmd': 'pg_restore --no-owner --no-acl --no-privileges --if-exists',
    }
}
